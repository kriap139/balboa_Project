...
void readSensorsACC()
{
  ...
  // Complementary Filter
    ...
    // T = UPDATE_TIME_S = 0.01, a = TIME_CONST = 0.75

    static const float a = 0.75;
    static const float T = 0.01;

    //int32_t angleRate_t = (avgFilterCount == 0) ? angleRate : (angleRate/avgFilterCount);
...
void loop()
{
  ...
  { 
      ...
      angle = (angle/avgFilterCount) / 1000;
      ...
      // to remove
        Serial.print(gyroAngleACC/avgFilterCount / 1000);
        Serial.print(" ");
        Serial.print(accelAngleACC/avgFilterCount / 1000); 
        Serial.print(" ");
        Serial.println(angle); 
        gyroAngleACC = 0;
        accelAngleACC = 0;
